...
FIRST_IMAGE = "img5.jpg"  # First image sent after start
PUNE_TRIP_MEDIA = ["fam1.jpeg" , "fam2.jpeg" ,"fam3.jpeg" ,"fam 4.jpeg" ,"fam 5.jpeg" ,"fam 6.jpeg" ,"fam 7.jpeg" ,"fam 8.jpeg" , "vid1.mp4" , "vid2.mp4" , "vid3.mp4" , ]  # Add all images/videos for Pune Trip

async def start(update: Update, context: CallbackContext) -> None:
    messages = [
        "HELLO I AM Abuzaid'S Sir Bot!",
        "I am a bot that will provide images and videos of the family trip...",
        "Hello! Send 'image' to receive the image."
    ]
    for msg in messages:
        await update.message.reply_text(msg)
    
    # Send the first image automatically
    image_path = os.path.join(MEDIA_FOLDER, FIRST_IMAGE)
    if os.path.exists(image_path):
        with open(image_path, "rb") as img:
            await update.message.reply_photo(photo=img)
    
    await update.message.reply_text("Want to relive past trips? Type the 'Pune Trip' name to see all images and videos!")
